// src/components/FamilyPackages.tsx
    ...
    <>
      <div className="mb-10 mt-8 text-center max-w-3xl mx-auto">
        <p className="font-sans text-base text-gray-600 leading-relaxed">
          Diseñado para documentar la conexión, las risas y el legado de tu familia o grupo. Creamos un ambiente relajado para que todos disfruten el momento.<br/>
          <span className="italic text-sm text-gray-400 mt-2 block">*Todos los paquetes incluyen cobertura de hasta 5 personas.</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div className="border border-gray-100 p-8 flex flex-col">
          ...
          <p className="font-sans text-xs uppercase tracking-widest text-gray-400 mb-6">Memoria Familiar</p>
        ...
        <div className="border-2 border-accent p-8 flex flex-col relative">
          ...
          <p className="font-sans text-xs uppercase tracking-widest text-gray-400 mb-6">Legado Generacional</p>
          <ul className="font-sans text-sm text-gray-600 space-y-3 mb-8 flex-grow">
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
            ...
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
              <span>Incluye fotos de grupo completo y subgrupos</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
          ...
          <div className="mt-auto">
            ...
            <Link href="/contact" className="block text-center w-full bg-secondary text-dominant uppercase tracking-widest text-xs py-3 hover:bg-opacity-90 transition-colors font-semibold">Reservar</Link>
          </div>
        </div>
        ...
        <div className="border border-gray-100 p-8 flex flex-col">
          ...
          <p className="font-sans text-xs uppercase tracking-widest text-gray-400 mb-6">Día en Familia</p>
          <ul className="font-sans text-sm text-gray-600 space-y-3 mb-8 flex-grow">
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
              <span>Sesión de <b>3 horas</b> en locación</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
              <span>Hasta 5 personas (1 cambio de vestuario opcional)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
              <span>Combinaciones múltiples (abuelos, niños, padres)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-accent flex-shrink-0 mt-0.5">•</span> 
          ...
          <div className="mt-auto">
            <p className="font-serif text-2xl text-secondary mb-4">$3,000 <span className="text-sm font-sans text-gray-400">MXN</span></p>
            <Link href="/contact" className="block text-center w-full bg-secondary text-dominant uppercase tracking-widest text-xs py-3 hover:bg-accent transition-colors">Reservar</Link>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 pt-8 mb-8">
        <div>
          ...
          <div className="flex justify-between items-start sm:items-center border-b border-gray-100 pb-3 mb-3 gap-4">
            ...
            <span className="font-sans font-semibold text-secondary whitespace-nowrap mt-0.5 sm:mt-0">$200 MXN / c.u.</span>
          </div>
      ...
      <div className="bg-dominant p-6 mb-10 text-center border border-gray-100">
        ...
        <p className="font-sans text-sm text-gray-600">
          Galería digital privada entregada en Alta Resolución y optimizada para uso en Redes Sociales. Tus memorias estarán respaldadas en la nube de forma gratuita por 3 meses.
        </p>
      </div>

      {/* Proceso de Trabajo */}
      <div className="bg-secondary text-dominant p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 text-center">
          <div>
            ...
            <p className="font-sans text-xs text-gray-400">Platicamos sobre el concepto, código de vestimenta y locación para el grupo.</p>
          </div>
          <div>
            ...
            <p className="font-sans text-xs text-gray-400">Agendamos la fecha con un anticipo para asegurar su espacio.</p>
          </div>
          <div>
            ...
            <p className="font-sans text-xs text-gray-400">Haremos tomas dinámicas y divertidas, asegurando que todos salgan increíbles.</p>
          </div>
          <div>
