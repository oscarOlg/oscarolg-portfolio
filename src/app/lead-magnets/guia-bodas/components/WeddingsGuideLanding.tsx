...
export default function WeddingsGuideLanding() {
  ...
  if (submitted) {
    return <LeadMagnetThankYou name={submittedName} guideType="weddings" />;
  }
  ...
  const whatsappLink = getWhatsAppLink("weddings", "es");
          ...
          >
            ...
            >
              <p className="text-sm text-gray-700">
                <span className="font-bold text-accent">Bonus:</span> Al descargar, recibirás una
                consulta especial vía WhatsApp para resolver tus dudas específicas sobre tu boda.
              </p>
            </motion.div>
          </motion.div>
